		...
		return (
			<div style={{ display: 'inline-flex' }}>
				...
				<div style={{ display: 'block', marginLeft: 0, marginBottom: -0, marginTop: 0 }}>
					<div>
						<Typography variant="overline" style={{ marginTop: 40, color: "rgb(255,248,41)", fontSize: 35, fontFamily: 'Playfair Display' }}>
					...
					<div className={classes.tableWrapper}>
						<Paper className={classes.root} style={{ margin: 10, borderRadius:"15px" }} >
							<Table className={classes.table} style={{'border-collapse': 'separate','border-radius': '15px'}}>
								<TableHead style={{ backgroundColor: "rgb(255,248,41)" }}>
									<TableRow>
										<TableCell style={{borderTopLeftRadius:"15px"}}>Nome Estabelecimento</TableCell>
										...
										<TableCell align="left"><b>Nome do Estabelicimento</b></TableCell>
										<TableCell align="left"><b>Status</b></TableCell>
										<TableCell align="left"><b></b></TableCell>
										<TableCell align="left" style={{borderTopRightRadius:"15px"}}><b></b></TableCell>
									</TableRow>
								</TableHead>
								<TableBody>
